...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            user.setBirthDate(new Date(Long.parseLong("306460800")));
            user.setMale(true);
            ...
            if (javaRush.hashCode() == loadedObject.hashCode()) {
                if (javaRush.equals(loadedObject)) {
                    System.out.println("javaRush и loadedObject равны");
                }
            } else {
                System.out.println("javaRush и loadedObject не равны");
            }
    ...
    public static class JavaRush {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            boolean isUsersEmpty = Boolean.parseBoolean(reader.readLine());
            if (!isUsersEmpty) {
                while (reader.ready()) {
                    User user = new User();
